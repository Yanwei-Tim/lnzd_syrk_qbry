...
<body>
	<div class="easyui-layout" data-options="fit:true">
		<!-- action="<%=basePath%>dwjcxxb/saveCheckTemp" -->
		<form action="<%=basePath%>dwjcxxb/beforeCheck" id="dataForm" name="dataForm" method="post">
			<input type="hidden" name="dwid" id="dwid" value="${entity.dwid}" />
			<input type="hidden" name="dwmc" id="dwmc" value="${entity.dwmc}" />
			<input type="hidden" name="flag" id="flag" value= "default"/>
				...
				<table border="0" cellpadding="0" cellspacing="10" width="100%" align="center">
					...
					<tr class="dialogTr" id="tr1">
						...
						<td width="34%" class="dialogTd" colspan="3">
							...
							<input type="radio" name="ywlbdm" checked value="04" openurl="dwjcxxb/add" flag="za"/>治安/内保 <a class="easyui-linkbutton" url="" iconCls="icon-preview" style="margin-left:330px;" onclick="preview('04');">查看</a></br>
							<input type="radio" name="ywlbdm" value="11" openurl="dwjcxxb/addXf" flag="xf"/>三级消防单位 <a class="easyui-linkbutton" url="" iconCls="icon-preview" style="margin-left:312px;" onclick="preview('11');">查看</a></br>
							<input type="radio" name="ywlbdm" value="12" openurl="dwjcxxb/add" flag="jb"/>环保单位 <a class="easyui-linkbutton" url="" iconCls="icon-preview" style="margin-left:336px;" onclick="preview('12');">查看</a></br>
							<input type="radio" name="ywlbdm" value="13" openurl="dwjcxxb/add" flag="ba"/>保安单位 <a class="easyui-linkbutton" url="" iconCls="icon-preview" style="margin-left:336px;" onclick="preview('13');">查看</a></br>
							<input type="radio" name="ywlbdm" value="14" openurl="jfjfjctz/addJfjfjctzs" flag="jf"/>技防单位 <a class="easyui-linkbutton" url="" iconCls="icon-preview" style="margin-left:336px;" onclick="preview('14');">查看</a>
						</td>
					</tr>
				</table>
			</div>
