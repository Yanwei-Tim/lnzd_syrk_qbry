			...
			<div id="datagridToolbar" style="padding: 5px;height: auto;">
				...
				<form id="queryForm">
					<table cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr class="dialogTr">
							    <td class="dialogTd" style="width:100px" align="right">养犬人证件号码：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							    	 <input type="text" name="zjhm" id ="zjhm" class="easyui-validatebox" data-options="required:false,validType:['sfzh'],tipPosition:'right'" maxlength="30" style="width:120px"/>
							    </td>
								<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
								<td class="dialogTd" style="width:90px" align="right">养犬人姓名：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							   		 <input type="text" name="xm" id ="xm" class="easyui-validatebox" data-options="required:false" maxlength="20" style="width:120px"/>
							    </td>
								<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
								<td class="dialogTd" style="width:100px" align="right">养犬人居住地址：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							   		 <input type="text" name="dz_jzdzxz" id ="dz_jzdzxz" class="easyui-validatebox" data-options="required:false" style="width:120px" maxlength="100"/>
							    </td>
							    <td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
							</tr>
							<tr>
							    <td class="dialogTd" style="width:100px" align="right">养犬用途 ：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							    	 <input type="text" name="yqytdm" id ="yqytdm" class="easyui-combobox" 
							    	        data-options="required:false,url: contextPath + '/common/dict/D_FWQZ_YQYT.js',
							    	        valueField:'id',textField:'text',
							    	        tipPosition:'left',
							    	        selectOnNavigation:false,method:'get'" 
									 style="width:120px"  maxlength="1000"/>
							    </td>
								<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
							    <td class="dialogTd" style="width:100px" align="right">犬型：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							   		<input type="text" name="qxdm" id ="qxdm" class="easyui-combobox" data-options="required:false,url: contextPath + '/common/dict/D_FWQZ_QXDM.js',valueField:'id',textField:'text',tipPosition:'left',selectOnNavigation:false,method:'get'" style="width:120px"/>
							    </td>
								<td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
							    <td class="dialogTd" style="width:90px" align="right">犬种：</td>
							    <td class="dialogTd" style="width:120px" align="right">
							        <input type="text" name="qzdm" id ="qzdm" class="easyui-combobox" data-options="required:false,url: contextPath + '/common/dict/D_FWQZ_QZDM.js',valueField:'id',textField:'text',tipPosition:'left',selectOnNavigation:false,method:'get'" style="width:120px"/>
							    </td>
							    <td class="toolbarTd"><div class="datagrid-btn-separator"></div></td>
