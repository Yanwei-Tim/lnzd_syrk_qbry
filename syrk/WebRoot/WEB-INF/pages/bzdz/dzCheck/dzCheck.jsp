...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=contextPath%>/js/bzdz/dzCheck/dzCheck.js"></script>
  </head>
			        ...
			        <table border="0" cellpadding="0" cellspacing="10" width="100%" height="100%" align="center">
				    	...
				    	<tr class="dialogTr" style="padding-bottom:0px;margin-bottom:0px;">
					    	<td colspan="3" align="right">
					    		<a class="easyui-linkbutton" iconCls="icon-ok" onclick="DzCheck.cancelButton();">确定</a>
					    		<a class="easyui-linkbutton" iconCls="icon-cancel" onclick="DzCheck.closeWindow();">关闭</a>
					    	</td>
				    	</tr>
			         </table>
		        </form>
