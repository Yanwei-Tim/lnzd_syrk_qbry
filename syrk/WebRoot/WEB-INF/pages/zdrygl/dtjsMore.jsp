		...
		if(index == 0 && initPages[index] != index){
			...
			$('#clxxtable').datagrid({    
			    ...
			    columns:[[
			       ...
			       {field:'csys',title:'车辆颜色',width:80,align:'center',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_CL_CSYS.js'},
			       {field:'jdchphm;',title:'车辆号码',width:200,align:'center',halign:'center'},
