		...
		if(index == 0 && initPages[index] != index){
			...
			$('#zdxsfzqkxxbtable').datagrid({    
			    ...
			    columns:[[
			        ...
			        {field:'sslb',title:'所属类别',width:120,align:'left',halign:'center',sortable:true,formatter:dictFormatter,dictName:contextPath+'/common/dict/BD_D_ZDRYLBDM.js'},
			        {field:'sslbxl',title:'所属类别细类',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/BD_D_ZDRYLBDM.js'},
			        {field:'zasd',title:'作案特点',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_QBLD_ZASD.js'},
			        {field:'zagj',title:'作案工具',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_QBLD_ZAGJ.js'},
			        {field:'zagjly',title:'作案工具来源',width:200,align:'left',halign:'center'},
			        {field:'zatd',title:'作案特点',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_ZATD.js'},
			        {field:'xzdx',title:'选择对象',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_XZDXDM.js'},
			        {field:'xzwp',title:'选择物品',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_BZ_XZWP.js'},
			        {field:'xzcs',title:'选择处所',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_QBLD_XZCS.js'},
			        {field:'xzsj',title:'选择时机',width:120,align:'left',halign:'center',formatter:dictFormatter,dictName:contextPath+'/common/dict/D_QBLD_XZSJ.js'},
			...
			$('#clxxtable').datagrid({    
        		...
        		nowrap:true,
			    columns:[[
			       {field:'zjhm',title:'证件号码',width:140,align:'center',halign:'center'},
