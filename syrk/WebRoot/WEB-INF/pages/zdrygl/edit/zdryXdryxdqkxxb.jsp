...
<title>吸毒人员吸毒信息</title>
	...
	function beforeSubmit() {
		if ($("#pk").val() == "") {
			$("#dataForm").attr('action', contextPath + '/zdryXdryxdqkxxb/save');
		}
		else {
			$("#dataForm").attr('action', contextPath + '/zdryXdryxdqkxxb/update');
		}
	}
	...
	<form action="" id="dataForm" name="dataForm" method="post">
		...
		<input type="hidden" id="zdryid" name="zdryid" value="${entity.zdryid}" />
	  	...
	  	<table border="0" cellpadding="0" cellspacing="10" align="left">
			...
			<tr class="dialogTr">
	    		<td class="dialogTd item_title" align="right">吸食情况：</td>
		    	<td class="dialogTd item_content">
		    		<input class="easyui-combobox" type="text" id="xsqkdm" name="xsqkdm" style="width:200px;" value="${entity.xsqkdm }"
			...
			<tr class="dialogTr">
		    	...
		    	<td class="dialogTd item_content">
		    		<input name="dplydm" id="dplydm" value="${entity.dplydm}" class="easyui-combobox" style="width:200px;" 
						data-options="url: contextPath + '/common/dict/JD_D_XDFSDM.js',valueField:'id',textField:'text',selectOnNavigation:false,method:'get',
						tipPosition:'left'"/>
		    	</td>
	    	...
	    	<tr><td colspan="4" style="height: 2px"></td></tr>
	   		...
	   		<tr class="dialogTr">
	    		<td class="dialogTd item_title" align="right">备注：</td>
		    	<td class="dialogTd item_content" colspan="3">
		    		<textarea name="fxchxz" id="bz" class="easyui-validatebox text_input" style="width:535px; height:24px;"
